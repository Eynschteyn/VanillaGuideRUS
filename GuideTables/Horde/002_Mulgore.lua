...
-----------10-12 Mulgore
	...
	[1012] = {
		...
		items = {
			...
			[14] = { str = "14. Run back to Bloodhoof Village but make sure you kill Prairie Alphas along the way until you have 8 Teeth." },
			[15] = { str = "15. Go to (49,60) and turn in #TURNIN\"Windmane Totem\"#.", x = 49, y = 60, zone = "Mulgore" },
			[16] = { str = "16. You should be level 12 now, if not grind to it then run into the Barrens following the path until you come to Camp Taurajo. Talk to Kirge Sternhorn (44,58) and accept #ACCEPT\"Journey to the Crossroads\"# and get the Flight Path.", x = 44, y = 58, zone = "Mulgore" },
			[17] = { str = "17. Run north up the road until you get to the Crossroads and turn in #TURNIN\"Journey to the Crossroads\"# get the Flight Path." },
			[18] = { str = "18. Now you can continue with the 12-15 Barrens guide which is in the 1-60 guide." },
			--[18] = { str = "." },
			--[19] = { str = "." },
    	}
	},
