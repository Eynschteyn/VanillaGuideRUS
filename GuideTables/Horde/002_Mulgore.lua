...
-----------6-10 Mulgore
	...
	[0610] = {
		...
		items = {
			...
			[7] = { str = "7. Идите в точку 33,41 убивайте гарпий получите 8 Windfury Talons. Затем идите в 31,50 и возьмите инструменты для зпдпния #DOQUEST\"Dwarven Digging\"#, тут вам нужно только собрать 5 кирок и идите дальше по гайду.", x = 33, y = 41, zone = "Mulgore" },
