...
-----------6-10 Mulgore
	...
	[0610] = {
		...
		items = {
			...
			[2] = { str = "2. #HUTNERВНИМАНИЕ в этом блоке может возникнуть путаница помните одно делайте все задания на 10-12 уровень которые найдете в локаци Мулгор и городе TB тут все рядом и последовательность шагов можно не соблюдать#" },
			[3] = { str = "3. Поговорите с Baine Bloodhoof и сдайте задание #TURNIN\"Rites of the Earthmother\"#, возьмите следующие #ACCEPT\"Sharing the Land\"#, #ACCEPT\"Rite of Vision\"# и #ACCEPT\"Dwarven Digging\"#." },
			[4] = { str = "4. Возьмите задание #ACCEPT\"Poison Water\"# 48,60. Поговорите с Zarlman Two-Moons 47,57 сдайте задание #TURNIN\"Rite of Vision\"# и возьмите следующую часть цепочки", x = 48, y = 60, zone = "Mulgore" },
			[5] = { str = "5. Возьмите задание в точке 47,62 #ACCEPT\"Dangers of the Windfury\"#, затем берите в точке 48,59 #ACCEPT\"Swoop Hunting\"# и задание в точке 47,57 #ACCEPT\"Mazzranache\"#.", x = 47, y = 62, zone = "Mulgore" },
			[6] = { str = "6. Идите на юго-восток 51,66 и бейте мобов собирайте все необходимое для заданий это все примерно в одной точке находится только 2 Well Stones находятся у колодца в точке 53,64", x = 51, y = 66, zone = "Mulgore" },
			[7] = { str = "7. Идите в точку 52,70 и убейте Palemane для задания #DOQUEST\"Sharing the Land\"#.", x = 52, y = 70, zone = "Mulgore" },
			[8] = { str = "8. Идите в точку 33,41 убивайте гарпий получите 8 Windfury Talons. Затем идите в 31,50 и возьмите инструменты для зпдпния #DOQUEST\"Dwarven Digging\"#, тут вам нужно только собрать 5 кирок и идите дальше по гайду.", x = 33, y = 41, zone = "Mulgore" },
			[9] = { str = "9. Идите в точку 59,62 и возьмите #ACCEPT\"The Ravaged Caravan\"#, далее идите в точку 54,48 и кликните по ящику и сдайте задание, затем возьмите следующее задание. Вернитесь в точку 59,62 сдайте задание и возьмите новые #ACCEPT\"The Venture Co.\"# и #ACCEPT\"Supervisor Fizsprocket\"#.", x = 59, y = 62, zone = "Mulgore" },
			[10] = { str = "10. Гриндите мобов если вы еще не получили 8 уровень" },
			[11] = { str = "11. Вернитесь в Bloodhoof Village и сдайте задания #TURNIN\"Poison Water\"#, #TURNIN\"Dangers of the Windfury\"#, #TURNIN\"Swoop Hunting\"# затем сдайте #TURNIN\"Rite of Vision\"# и возьмите следующее задание из цепочки. Возьмите задание #ACCEPT\"Winterhoof Cleansing\"#." },
			[12] = { str = "12. Идите в точку 53,67 и очистите ее с помощью Thunderhorn's item. затем вернитесь Mull Thunderhorn 49,60 и сдайте задание #TURNIN\"Winterhoof Cleansing\"# и возьмите #ACCEPT\"Thunderhorn Totem\"#.", x = 53, y = 67, zone = "Mulgore" },
			[13] = { str = "13. Идите в точку 47,57 и выпейте #TURNIN\"Water of the Seers\"# из своего рюкзака и следуйте за духом волка", x = 47, y = 57, zone = "Mulgore" },
			[14] = { str = "14. Сдайте задание #TURNIN\"Rite of Vision\"# в точке 33,36 когда дух остановится и возьмите задание #ACCEPT\"Rite of Wisdom\"#.", x = 33, y = 36, zone = "Mulgore" },
			[15] = { str = "15. Идите в точку 59,25 и возьмите задание #ACCEPT\"A Sacred Burial\"#. ", x = 59, y = 25, zone = "Mulgore" },
			[16] = { str = "16. Идите к Ancestral Spirit у красных скал в точке 60,21 и сдайте задание #TURNIN\"Rite of Wisdom\"#, возьмите задание #ACCEPT\"Journey into Thunder Bluff\"# и бейте 8 Bristleback неподалеку после поговорите Lorekeeper Raintotem 59,25 и сдайте задание #TURNIN\"A Sacred Burial\"#", x = 60, y = 21, zone = "Mulgore" },
			[17] = { str = "17. Идите в Thunder Bluff к кузнеце 39,55 и уничтожте Prospector's Picks щелкнув по ним", x = 39, y = 55, zone = "Thunder Bluff" },
			[18] = { str = "18. Идите в точку 69,51 и поговорите с Cairne Bloodhoof и сдайте задание #TURNIN\"Journey into Thunder Bluff\"#, возьмите следующее #ACCEPT\"Rise of the Earthmother\"#.", x = 69, y = 51, zone = "Thunder Bluff" },
			[19] = { str = "19. Сейчас у вас должен быть 10 уровень, если нет то гриндите мобов. Выполните свои классовые задания на 10 уровне, но вы можете качаться дальше по гайду и сделать эти задания на 12 уровне что бы качаться дальше с новой главы" },
			--[19] = { str = "." },
			--[20] = { str = "." },
		}
	},
