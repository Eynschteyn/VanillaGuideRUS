...
-----------6-10 Mulgore
	...
	[0610] = {
		...
		items = {
			...
			[2] = { str = "2. Talk to Baine Bloodhoof and turn in #TURNIN\"Rites of the Earthmother\"# accept #ACCEPT\"Sharing the Land\"#, #ACCEPT\"Rite of Vision\"# and #ACCEPT\"Dwarven Digging\"#." },
			[3] = { str = "3. Accept #ACCEPT\"Poison Water\"# from Mull Thunderhorn (48,60). Talk to Zarlman Two-Moons (47,57) turn in #TURNIN\"Rite of Vision\"# and accept part 2.", x = 48, y = 60, zone = "Mulgore" },
			[4] = { str = "4. Talk to Ruul Eagletalon (47,62) accept #ACCEPT\"Dangers of the Windfury\"# then talk to Harken Windtotem (48,59) and accept #ACCEPT\"Swoop Hunting\"#. Talk to Maur Raincaller (47,57) accept #ACCEPT\"Mazzranache\"#.", x = 47, y = 62, zone = "Mulgore" },
			[5] = { str = "5. Go southeast to (51,66) and kill Trophy Swops for 8 Quills, Prairie Wolfs for 6 Paws, Plainstriders for 4 Talons and underneath trees loot 2 Ambercorns and 2 Well Stones near the well (53,64).", x = 51, y = 66, zone = "Mulgore" },
			[6] = { str = "6. Go to (52,70) and kill the Palemane for #DOQUEST\"Sharing the Land\"#.", x = 52, y = 70, zone = "Mulgore" },
