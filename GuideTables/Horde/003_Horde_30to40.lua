...
-----------30-30 Arathi Highlands
	...
	[3030] = {
		...
		items = {
			...
			[2] = { str = "2. go do this quest:" },
			[3] = { str = "3. #DOQUEST\"The Hammer May Fall\"# (at 34.45)", x = 34, y = 45, zone = "Arathi Highlands" },
			[4] = { str = "4. Then run to Hammerfall (at 73.36)", x = 73, y = 36, zone = "Arathi Highlands" },
			[5] = { str = "5. Accept #ACCEPT\"Hammerfall\"# " },
			[6] = { str = "6. Turn in #TURNIN\"Hammerfall\"# ... accept #ACCEPT\"Raising Spirits\"# " },
			[7] = { str = "7. Turn in #TURNIN\"The Hammer May Fall\"# " },
			[8] = { str = "8. Get FP there." },
			[9] = { str = "9. Then do #DOQUEST\"Raising Spirits\"# (just to the left of Hammerfall all around 64.37).  Then turn it in ... accept #ACCEPT\"Raising Spirits\"# part2", x = 64, y = 37, zone = "Arathi Highlands" },
			[10] = { str = "10. Turn in #TURNIN\"Raising Spirits\"# part2 ... accept #ACCEPT\"Raising Spirits\"# part3" },
			[11] = { str = "11. Turn in #TURNIN\"Raising Spirits\"# part3 ... skip \"#NPCGuile of the Raptor\"# for now" },
			[12] = { str = "12. Hearth to Orgrimmar." },
			[13] = { str = "13. Fly to Crossroads." },
			[14] = { str = "14. run west in the Crossroads ... accept #ACCEPT\"The Swarm Grows\"# " },
			[15] = { str = "15. then run west from the Crossroads to the guy in the hut ... accept #ACCEPT\"The Kolkar of Desolace\"# " },
			[16] = { str = "16. run back to Crossroads, make Crossroads your home." },
			[17] = { str = "17. fly to Ratchet" },
			[18] = { str = "18. get on the boat at Ratchet to go to BB..." },
		}
	},
...
-----------30-31 Stranglethorn Vale
	...
	[3031] = {
		...
		items = {
			...
			[2] = { str = "2. Get the FP at BB and run up to Grom'Gol (get the FP there too)." },
			[3] = { str = "3. Go up north (35.10) and start doing the STV hunt quests:", x = 35, y = 10, zone = "Stranglethorn Vale" },
			[4] = { str = "4. #DOQUEST\"Welcome to the Jungle\"# (just accept this and turn in in right there)" },
			[5] = { str = "5. #DOQUEST\"Tiger Mastery\"# (#NPCYoung Stranglethorn Tigers#) (33.10)", x = 33, y = 10, zone = "Stranglethorn Vale" },
			[6] = { str = "6. #DOQUEST\"Panther Mastery\"# (#NPCYoung Panthers#) (41.9)", x = 41, y = 9, zone = "Stranglethorn Vale" },
			[7] = { str = "7. #DOQUEST\"Panther Mastery\"# (#NPCPanthers#) (30.11)", x = 30, y = 11, zone = "Stranglethorn Vale" },
			[8] = { str = "8. #DOQUEST\"Tiger Mastery\"# (#NPCStranglethorn Tigers#) (30.10)", x = 30, y = 11, zone = "Stranglethorn Vale" },
			[9] = { str = "9. #DOQUEST\"Raptor Mastery\"# (#NPCStranglethorn Raptors#) (25.15)", x = 25, y = 15, zone = "Stranglethorn Vale" },
			[10] = { str = "10. Accept #ACCEPT\"Tiger Mastery\"# (#NPCElder Stranglethorn Tigers#) .. but don't do it now." },
			[11] = { str = "11. Accept #ACCEPT\"Raptor Mastery\"# (#NPCLashtail Raptors#) .. but don't do it now." },
			[12] = { str = "12. Skip the rest for now." },
			[13] = { str = "13. You should belvl 31 for sure, if not grind to it" },
			[14] = { str = "14. Hearth to Crossroads." },
			[15] = { str = "15. Fly to 1K needles." },
			[16] = { str = "16. Go east into Shimmering Flats (at 77.77)...", x = 77, y = 77, zone = "Thousand Needles" },
		}
	},
...
-----------31-32 Thousand needles (Shimmering Flats)
	...
	[3132] = {
		...
		items = {
			...
			[18] = { str = "17) Hearth to Crossroads." },
