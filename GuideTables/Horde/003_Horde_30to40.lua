...
-----------30-30 Arathi Highlands
	...
	[3030] = {
		...
		items = {
			...
			[13] = { str = "12) Fly to Crossroads." },
			[14] = { str = "13) run west in the Crossroads ... accept #ACCEPT\"The Swarm Grows\"# " },
			[15] = { str = "14) then run west from the Crossroads to the guy in the hut ... accept #ACCEPT\"The Kolkar of Desolace\"# " },
			[16] = { str = "15) run back to Crossroads, make Crossroads your home." },
...
-----------30-31 Stranglethorn Vale
	...
	[3031] = {
		...
		items = {
			...
			[14] = { str = "13) Hearth to Crossroads." },
