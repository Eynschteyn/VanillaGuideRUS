...
-----------12-15 Barrens
	...
	[1215] = {
		...
		items = {
			...
			[4] = { str = "4. Бегите в XRs (Crossroads) в точку 52,30 #HUNTER (Если вы hunter выполните 5 пункт)#", x = 52, y = 30, zone = "The Barrens" },
			[5] = { str = "#HUNTER5. ПО пути в XRs, я отпускаю краба и приручаю Savannah Huntress cat в качестве нового петомца#" },
			[6] = { str = "6. В XRs в точке 52,30 сдайте задание #TURNIN\"Crossroads Conscription\"# Затем возьмите все задания в XRs (включая: #ACCEPT\"Meats to Orgrimmar\"#, #ACCEPT\"Plainstrider Menace\"#, #ACCEPT\"The Forgotten Pools\"#, #ACCEPT\"Raptor Thieves\"#, #ACCEPT\"Wharfmaster Dizzywig\"#, #ACCEPT\"Fungal Spores\"#, #ACCEPT\"Disrupt the Attacks\"#, #ACCEPT\"Supplies for the Crossroads\"# и #ACCEPT\"Harpy Raiders\"# последнее находится на башне). Сдайте задание #TURNIN\"Meats to Orgrimmar\"# и ПРОПУСТИТЕ \"#NPCRide to Orgrimmar\"# ", x = 52, y = 30, zone = "The Barrens" },
			[7] = { str = "7. Сделайте XRs вашим домом" },
			...
			[10] = { str = "10. Once #DOQUEST\"Disrupt the Attacks\"# is completed go turn it in (at 52.30) and accept #ACCEPT\"Supplies for the Crossroads\" ", x = 52, y = 30, zone = "The Barrens" },
			[11] = { str = "11. Go do #DOQUEST\"Supplies for the Crossroads\"# (at 56.26), then run back to Thork and #ACCEPT\"The Disruption Ends\"#, you'll be going back up to the razormanes one more time.", x = 56, y = 26, zone = "The Barrens" },
			[12] = { str = "12. If you find #ACCEPT\"Chen's Empty Keg\"# accept it." },
			[13] = { str = "13. Once #DOQUEST\"Plainstrider Menace\"# & #DOQUEST\"The Disruption Ends\"# are complete..." },    
			[14] = { str = "14. Go to Ratchet, get the Flight Path there (63.37) and accept #ACCEPT\"Raptor Horns\"# #ACCEPT\"Samophlange\"# #ACCEPT\"Southsea Freebooters\"#  #ACCEPT\"The Guns of Northwatch\"# .  Turn in #TURNIN\"Chen's Empty Keg\"# if you have it ... accept the next part to it, and focus on doing this quest while throughout the Barrens.", x = 63, y = 37, zone = "The Barrens" },
			[15] = { str = "15. Grab the quest #ACCEPT\"WANTED: Baron Longshore\"# (the wanted sign by the bank)" },
			[16] = { str = "16. Turn in #TURNIN\"Wharfmaster Dizzywig\"# (goblin on the docks) accept #ACCEPT\"Miner's Fortune\"# " },
			[17] = { str = "17. Then go do #DOQUEST\"Southsea Freebooters\"# along with #DOQUEST\"WANTED: Baron Longshore\"# (along the shore just south of Ratchet)" },
			[18] = { str = "18. Once those are done, turn them in (at 63.36), accept new ones, then go do:", x = 63, y = 36, zone = "The Barrens" },
			[19] = { str = "19. #TURNIN\"The Missing Shipment\"# (just turn this in at the goblin at the docks) accept #ACCEPT\"The Missing Shipment\"# part2" },
			[20] = { str = "20. Run back, to Gazlowe (63.36), turn in #TURNIN\"The Missing Shipment\"# part2 accept #ACCEPT\"Stolen Booty\"# ", x = 63, y = 36, zone = "The Barrens" },
			[21] = { str = "21. Then go do #DOQUEST\"Stolen Booty\"# (south of Ratchet again) (Telescopic Lens=64.49, and Shipment of Boots=63.50)", x = 63, y = 50, zone = "The Barrens" },
			[22] = { str = "22. Once #DOQUEST\"Stolen Booty\"#  is completed hearth to XRs. (don't turn it in yet)" },
			[23] = { str = "23. Turn in #TURNIN\"The Disruption Ends\"# and #TURNIN\"Supplies for the Crossroads\"# " },
			[24] = { str = "24. Turn in #TURNIN\"Plainstrider Menace\"# (It should be done by now) accept #ACCEPT\"The Zhevra\"# .  Also accept #ACCEPT\"Consumed by Hatred\"# and #ACCEPT\"Lost in Battle\"# " },
			[25] = { str = "25. At this point, I make sure I have three/four 6 slot bags, if I don't, I buy them at the bag vendor." },
			[26] = { str = "26. Run west from XRs, go to the guy in the hut... (at 45.28)", x = 45, y = 28, zone = "The Barrens" },
			[27] = { str = "27. Accept: #ACCEPT\"Kolkar Leaders\"# and #ACCEPT\"Centaur Bracers\"# " },
			[28] = { str = "28. Then go start doing:" },
			[29] = { str = "29. #DOQUEST\"Kolkar Leaders\"# #DOQUEST\"Centaur Bracers\"# #DOQUEST\"Raptor Thieves\"# #DOQUEST\"The Zhevra\"# #DOQUEST\"Fungal Spores\"#  and  #DOQUEST\"The Forgotten Pools\"# (all of these are done just slightly north of where you are)" },
			[30] = { str = "30. Once #DOQUEST\"Kolkar Leaders\"# is done.. (Barak is at 43.24) ", x = 43, y = 24, zone = "The Barrens" },
			[31] = { str = "31. Go do: #DOQUEST\"Harpy Raiders\"# (at 38.17)", x = 38, y = 17, zone = "The Barrens" },
			[32] = { str = "32. Once #DOQUEST\"Harpy Raiders\"# is done, grind your way down into Stonetalon Mountains (at 35.27 in the Barrens)...", x = 35, y = 27, zone = "The Barrens" },
			--[33] = { str = "." },
			--[34] = { str = "." },
		}
	},
...
-----------16-20 Barrens PART1
	...
	[1618] = {
		...
		items = {
			...
			[4] = { str = "4. Make sure you finish up #DOQUEST\"Raptor Thieves\"# #DOQUEST\"The Zhevra\"# #DOQUEST\"Fungal Spores\"# and #DOQUEST\"The Forgotten Pools\"# before returning to the XRs." },
			[5] = { str = "5. Run to XRs (Cross Roads at 52.30)", x = 52, y = 30, zone = "The Barrens" },
			...
			[15] = { str = "15. Go up to the tower in middle of town to get FP, but DON'T fly back to XRs." },
			[16] = { str = "16. Hearth back to XRs." },
			[17] = { str = "17. Turn in #TURNIN\"Lost in Battle\"# " },
			[18] = { str = "18. Then go north west of XRs and do #DOQUEST\"Prowlers of the Barrens\"# (37.20)", x = 37, y = 20, zone = "The Barrens" },
			...
			[28] = { str = "28. Then run to XRs (52.30)..", x = 52, y = 30, zone = "The Barrens" },
			...
			[30] = { str = "30. Go west of XRs (45.28), to turn in: #TURNIN\"Centaur Bracers\"# and #TURNIN\"Verog the Dervish\"# ... I SKIP \"#NPCHezrul Bloodmark\"# ", x = 45, y = 28, zone = "The Barrens" },
...
-----------16-20 Barrens PART2
	...
	[1820] = {
		...
		items = {
			...
			[16] = { str = "16. Once you are at least 5 bars away from 20, run to XRs..." },
			...
			[28] = { str = "28. Hearth to XRs. (if hearth stone is still on a cooldown, fly to XRs)" },
