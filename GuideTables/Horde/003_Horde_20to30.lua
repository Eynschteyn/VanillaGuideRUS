...
-----------23-25 Stonetalon Mountains
	...
	[2325] = {
		...
		items = {
			...
			[2] = { str = "2. Accept all quests at Sun Rock Retreat (which include: #ACCEPT\"Cenarius' Legacy\"# #ACCEPT\"Cycle of Rebirth\"# and #ACCEPT\"Harpies Threaten\"# )..." },
			[3] = { str = "3. Make Sun Rock Retreat your home." },
			[4] = { str = "4. Turn in #TURNIN\"Boulderslide Ravine\"# .. I SKIP \"#NPCEarthen Arise\"# (accept #ACCEPT\"Elemental War\"# there though)" },
			[5] = { str = "5. Do:" },
			[6] = { str = "6. #DOQUEST\"Cycle of Rebirth\"#   (pick up the seeds around 48.41)", x = 48, y = 41, zone = "Stonetalon Mountains" },
			[7] = { str = "7. #DOQUEST\"Cenarius' Legacy\"#   (done at around 35.14)", x = 35, y = 14, zone = "Stonetalon Mountains" },
			[8] = { str = "8. #DOQUEST\"Jin'Zil's Forest Magic\"# (the mobs are around the path at 45.27, and the area at 34.14)", x = 45, y = 27, zone = "Stonetalon Mountains" },
			[9] = { str = "9. Go back to Sun Rock Retreat and turn in #TURNIN\"Cycle of Rebirth\"# ... accept #ACCEPT\"New Life\"# " },
			[10] = { str = "10. Turn in #TURNIN\"Cenarius' Legacy\"# ... accept  #ACCEPT\"Ordanus\"# " },
			[11] = { str = "#HUNTER11. NOTE: I skip getting my level 24 spells/abilities (cause there's little that are useful at this level)#" },
			[12] = { str = "12. Go turn in #TURNIN\"Further Instructions\"# part2 (58.62)... accept #ACCEPT\"Gerenzo Wrenchwhistle\"# ", x = 58, y = 62, zone = "Stonetalon Mountains" },
			[13] = { str = "13. Go do #DOQUEST\"Gerenzo Wrenchwhistle\"# (at 64.41)  and #DOQUEST\"Shredding Machines\"#   (kill #NPCXT:4# and #NPCXT:9#)", x = 64, y = 41, zone = "Stonetalon Mountains" },
			[14] = { str = "14. Then turn in #TURNIN\"Gerenzo Wrenchwhistle\"# . (58.62). If you couldn't do Arachnophobia, do it now!", x = 58, y = 62, zone = "Stonetalon Mountains" },
			[15] = { str = "15. Run down south and turn in #TURNIN\"Jin'Zil's Forest Magic\"# (74.97)", x = 74, y = 97, zone = "Stonetalon Mountains" },
			[16] = { str = "16. Turn in #TURNIN\"Shredding Machines\"# (in the Barrens at 35.27)", x = 35, y = 27, zone = "The Barrens" },
			[17] = { str = "17. Hearth back to Sun Rock Retreat and turn in #TURNIN\"Arachnophobia\"# if you just did it." },
			[18] = { str = "18. Stock back up on food/water." },
			[19] = { str = "19. Go do #DOQUEST\"Harpies Threaten\"# along with #DOQUEST\"Elemental War\"# and #DOQUEST\"New Life\"# (all at the Charred Vale, 32.67)", x = 32, y = 67, zone = "Stonetalon Mountains" },
			[20] = { str = "20. Once they are all done, make sure you are at least 5 bars away from level 25, so you may have to grind a little.  " },
			[21] = { str = "21. Then go turn them all in, and accept #ACCEPT\"Calling in the Reserves\"# " },
			[22] = { str = "22. Then fly to CT..." },
			--[23] = { str = "." },
			--[24] = { str = "." },
		}
	},
...
-----------25-25 Southern Barrens2
	...
	[2525] = {
		...
		items = {
			...
			[2] = { str = "2. Turn in #TURNIN\"Ishamuhale\"# ... accept #ACCEPT\"Enraged Thunder Lizards\"# " },
			[3] = { str = "3. Make CT your home." },
			[4] = { str = "4. Accept #ACCEPT\"A New Ore Sample\"# (need to be lvl 25 to get this)" },
			[5] = { str = "5. Go down and do:" },
			[6] = { str = "6. #DOQUEST\"Enraged Thunder Lizards\"# " },
			[7] = { str = "7. You should find the mob #NPCWashte Pawne#, he drops 'Washte Pawne Feather' which starts #ACCEPT\"Washte Pawne\"# " },
			[8] = { str = "8. #DOQUEST\"Revenge of Gann\"# (at 47.85) Once done, Turn it in, accept the next part...", x = 47, y = 85, zone = "The Barrens" },
			[9] = { str = "9. Do #DOQUEST\"Revenge of Gann\"# Part 3 (at 46.85), then turn it in.", x = 46, y = 85, zone = "The Barrens" },
			[10] = { str = "10. Head south down the path to the Great Lift (at 44.91 in the barrens) and turn in #TURNIN\"Calling in the Reserves\"# ", x = 44, y = 91, zone = "The Barrens" },
			[11] = { str = "11. Accept #ACCEPT\"Message to Freewind Post\"# " },
			[12] = { str = "12. Run to Freewind Post... (45.50 in Thousand Needles)", x = 45, y = 50, zone = "Thousand Needles" },
			--[13] = { str = "." },
			--[14] = { str = "." },
		}
	},
