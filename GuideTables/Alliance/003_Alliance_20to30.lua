...
-----------23-24 Darkshore
    ...
    [2324] = {
        ...
        items = {
            ...
            [2] = { str = "2. Сдайте оба задания #TURNINBeached Sea Turtle#" },
            [3] = { str = "3. Сделайте Auberdine своим домом" },
            [4] = { str = "4. Сдайте задание #TURNINThe Absent Minded Prospector pt.2# (рядом с домом торговца) и возьмите задание #ACCEPTThe Absent Minded Prospector pt.3#" },
            [5] = { str = "5. Идите в последний дом и возьмите задание #ACCEPTA Lost Master#." },
            [6] = { str = "6. Летите в Darnassus и сдайте задание #TURNINThe Absent Minded Prospector pt.3# у храма Temple of the Moon в точке 31,84 возьмите задание #ACCEPTThe Absent Minded Prospector pt.4#", x = 31, y = 84, zone = "Darnassus" },
            [7] = { str = "7. Летите в Auberdine." },
            [8] = { str = "8. Идите в точку 58,21 для выполнения задания #DOQUESTMathystra Relics# они разбросаны повсюду", x = 58, y = 21, zone = "Darkshore" },
            [9] = { str = "9. Идите в точку 56,13 возьмите #ACCEPTGyromast's Retrieval# убивайте raging reef crawlers в этой местности, а так же мурлоков к северу отсюда около коробля в точке 55,12", x = 56, y = 13, zone = "Darkshore" },
            [10] = { str = "10. Идите на север от Ruins of Mathystra убивайте sire’s и matriach’s для задания #DOQUESTA Lost Master#, а так же Foreststriders для задания #DOQUESTGyromast's Retrieval#" },
            [11] = { str = "11. Сдайте задание #TURNINGyromast's Retrieval# в точке 56,13, и возьмите новое #ACCEPTGyromast's Revenge#.", x = 56, y = 13, zone = "Darkshore" },
            ...
            [14] = { str = "14. Сдайте задание #TURNINA Lost Master pt.1# у первого дома в городе и возьмите следующее #ACCEPTA Lost Master pt.2#" },
            [15] = { str = "15. Идите по координатам 43,76 и сдайте задание #TURNINMathystra Relics#.", x = 43, y = 76, zone = "Darkshore" },
            [16] = { str = "16. Идите в точку 41,81 используйте /wave НПС Grimclaw He’ll он укажет на пещеру на юго-западе идите туда 45,85 и сдайте задание #TURNINA Lost Master pt.2# и возьмите #ACCEPTEscape Through Force# сопроводите его обратно к Grimclaw в точку 41,81.", x = 41, y = 81, zone = "Darkshore" },
            ...
            [19] = { str = "19. Сдайте задание #TURNINEscape Through Force# в доме прежде чем уходить из города, возьмите задание #ACCEPTTrek to Ashenvale#" },
