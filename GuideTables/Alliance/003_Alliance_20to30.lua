...
-----------24-25 Ashenvale
    ...
    [2425] = {
        ...
        items = {
            ...
            [2] = { str = "2. Turn in  #TURNIN\"Trek to Ashenvale\"#  right in front of you when you hearth." },
            [3] = { str = "3. Run to the house on the East side, turn in  #TURNIN\"The Ruins of Stardust\"#  accept  #ACCEPT\"Fallen Sky Lake\"#." },
            [4] = { str = "4. Run to the West side of town, turn in  #TURNIN\"Pridewings of Stonetalon\"#  accept  #ACCEPT\"Kayneth Stillwind\"#" },
            [5] = { str = "5. Grind every mob down into Fire Scar Shrine and kill #NPCIlkruk Mathrull# at 25,61 for  #DOQUES\"TThe Tower of Althalaxx pt.5\"#  Take him out as fast as you can. He summons 2 voidwalkers if you take too long.", x = 25, y = 61, zone = "Ashenvale" },
            [6] = { str = "6. Grind a path up to between 35,33 and 36,36 (he patrols) and kill #NPCDal Bloodclaw# for  #DOQUEST\"Culling the Threat\"#.", x = 35, y = 33, zone = "Ashenvale" },
            [7] = { str = "7. I then grind furbolg’s until I’m half way to level 25 " },
            [8] = { str = "8. Then run to Maestra’s Post at 26,38 turn in  #TURNIN\"The Tower of Althalaxx pt.5\"#  accept  #ACCEPT\"The Tower of Althalaxx pt.6\"#.", x = 26, y = 38, zone = "Ashenvale" },
            [9] = { str = "9. Accept  #ACCEPT\"Supplies to Auberdine  (escort)\"# may seem out of the way, you run into a fight of 4, and 2 fights of 3. You only go to the darkshore border and it completes. Easy 2900 xp, not far out of the way. Turn it back in at 26,38.", x = 26, y = 38, zone = "Ashenvale" },
            [10] = { str = "10. Run to Astranaar" },
            [11] = { str = "11. Turn in  #TURNIN\"Culling the Threat\"#  at the inn " },
            [12] = { str = "12. Go to 49,56 then grind north to 53,46 turn in  #TURNIN\"Raene’s Cleansing pt.3\"#  accept  #ACCEPT\"Raene’s Cleansing pt.4\"#.", x = 53, y = 46, zone = "Ashenvale" },
            [13] = { str = "13. Run down to Silverwing Refuge at 49,67 and accept #ACCEPT\"Elemental Bracers\"# do it in the lake here.", x = 49, y = 67, zone = "Ashenvale" },
...
-----------25-27 Wetlands
    ...
    [2526] = {
        ...
        items = {
            ...
            [2] = { str = "2. Stop at the end of the docks, accept  #ACCEPT\"Claws From the Deep\"#" },
            [3] = { str = "3. On the west side of town accept  #ACCEPT\"Young Crocolisk Skins\"#" },
            [4] = { str = "4. Go to the top of the castle, accept  #ACCEPT\"War Banners\"#" },
            [5] = { str = "5. On the east side of town accept  #ACCEPT\"Digging Through the Ooze\"#" },
            [6] = { str = "6. In front of the Inn accept  #ACCEPT\"The Third Fleet\"# and #ACCEPT\"The Greenwarden\"#" },
            [7] = { str = "7. Make Menethil Harbor your home" },
            [8] = { str = "8. Go upstairs in the inn, turn in  #TURNIN\"The Absent Minded Prospector pt.4\"# accept #ACCEPT\"The Absent Minded Prospector pt.5\"#" },
            [9] = { str = "9. Buy a  #NPCFlagon of Mead#  from the bartender for  #DOQUEST\"The Third Fleet\"#  and give it to the guy outside the inn. Accept  #ACCEPT\"The Cursed Crew\"#" },
            [10] = { str = "10. On the bridge accept  #ACCEPT\"In Search of the Excavation Team pt.1\"#" },
            [11] = { str = "11. Kill Young Crocolisks just east of the bridge around 14,52 and north on the land of the lake also along the road to the greenwarden for  #DOQUEST\"Young Crocolisk Skins\"#", x = 14, y = 52, zone = "Wetlands" },
            [12] = { str = "12. Kill Bluegill Murlocs and Gobbler at 18,40 for  #DOQUEST\"Claws From the Deep\"#", x = 18, y = 40, zone = "Wetlands" },
            [13] = { str = "13. Kill Mottled Raptors and Screechers around 25,46 for  #DOQUEST\"The Absent Minded Prospector pt.5\"#", x = 25, y = 46, zone = "Wetlands" },
            [14] = { str = "14. Enter the Excavation Site at 34,40.", x = 34, y = 40, zone = "Wetlands" },
            [15] = { str = "15. Run up the path on the left and grab the fossil near the 2 npc’s at 38,52 for  #DOQUEST\"The Absent Minded Prospector pt.5\"#", x = 38, y = 52, zone = "Wetlands" },
            [16] = { str = "16. Turn in  #TURNIN\"In Search of the Excavation Team pt.1\"#  accept  #ACCEPT\"In Search of the Excavation Team pt.2\"#" },
            [17] = { str = "17. Accept  #ACCEPT\"Uncovering the Past\"#." },
            [18] = { str = "18. Outside the cave accept  #ACCEPT\"Ormer s Revenge pt.1\"#" },
            [19] = { str = "19. Go back to where you killed the raptors a few minutes ago at 25,46 and do  #DOQUEST\"Ormer's Revenge pt.1\"#  by killing mottled raptors and screechers.", x = 25, y = 46, zone = "Wetlands" },
            [20] = { str = "20. Run back up to the cave at 38,52 and turn in  #TURNIN\"Ormer's Revenge pt.1\"#  accept  #ACCEPT\"Ormer’s Revenge pt.2\"#", x = 38, y = 52, zone = "Wetlands" },
            [21] = { str = "21. Now do both  #DOQUEST\"Ormer’s Revenge pt.2\"#  by killing Scythclaw and Razormaw Raptors below, and  #DOQUEST\"Uncovering the Past\"#  relics for this are all around the raptors. There are 4 different ones that randomly spawn but each is in it’s own shape which are: (Modr=Thin Red Vase) (Golm=Fat Yellow Vase) (Neru=Dirt Pile) (Ados=Tomb)." },
            [22] = { str = "22. Go back up to 38,52 and turn in  #TURNIN\"Ormer’s Revenge pt.2\"#  accept  #ACCEPT\"Ormer’s Revenge pt.3\"#", x = 38, y = 52, zone = "Wetlands" },
            [23] = { str = "23. Turn in  #TURNIN\"Uncovering the Past\"#" },
            [24] = { str = "24. Do  #DOQUEST\"Ormer’s Revenge pt.3\"#  atop the hill at 32,51 #NPCSarltooth# is a 29 But he’s as easy as the others. Go turn it back in at 38,52.", x = 32, y = 51, zone = "Wetlands" },
            [25] = { str = "25. Go in to Angerfang Encampment at 43,40 and do  #DOQUEST\"War Banners\"#", x = 43, y = 40, zone = "Wetlands" },
            [26] = { str = "26. Stop at 49,39 accept #ACCEPT\"Daily Delivery\"#.", x = 49, y = 39, zone = "Wetlands" },
            [27] = { str = "27. Run straight East from here to 56,40 and turn in  #TURNIN\"The Greenwarden\"#  accept  #ACCEPT\"Tramping Paws\"#", x = 56, y = 40, zone = "Wetlands" },
            [28] = { str = "28. Kill #NPCMosshide# around 56,74 for  Tramping Paws  at the camp. They’re a fast respawn I couldn’t kill them fast enough. Turn it in at 56,40 and accept  #ACCEPT\"Fire Taboo\"#  You should be level 26 by now, if not you will be soon", x = 56, y = 74, zone = "Wetlands" },
            [29] = { str = "29. Do  #DOQUEST\"Fire Taboo\"#  by killing any mosshides but the ones you just killed, The flints are easily dropped by the ones around 44,33 there is a few.", x = 44, y = 33, zone = "Wetlands" },
            [30] = { str = "30. Turn in  #TURNIN\"Fire Taboo\"#  at 56,40 accept  #ACCEPT\"Blisters on the Land\"#  Now this is one of those quests you just do as you go. Fen Creepers are stealthed elementals that lurk in the water. If you see one, kill it.", x = 56, y = 40, zone = "Wetlands" },
            [31] = { str = "31. Hearth back to Menethil Harbor." },
            [32] = { str = "32. Turn in  #TURNIN\"The Absent Minded Prospector pt.5\"#  2nd floor of the Inn" },
            [33] = { str = "33. Go inside the castle upstairs, turn in  #TURNIN\"War Banners\"#  accept  #ACCEPT\"Nek'Rosh's Gambit\"#" },
            [34] = { str = "34. On the west side of town turn in #TURNIN\"Daily Delivery\"# and  #TURNIN\"Young Crocolisk Skins\"#  accept  #ACCEPT\"Apprentice's Duties\"#" },
            [35] = { str = "35. Go on the dock and turn in  #TURNIN\"Claws From the Deep\"#  accept  #ACCEPT\"Reclaiming Goods\"#" },
            [36] = { str = "36. On the bridge turn in  #TURNIN\"In Search of the Excavation Team pt.2\"#" },
            ...
            [38] = { str = "38. Touch the damaged crate at 13,41 turn in  #TURNIN\"Reclaiming Goods\"#  accept  #ACCEPT\"The Search Continues\"#.", x = 13, y = 41, zone = "Wetlands" },
            [39] = { str = "39. Go just north to the next camp touch the sealed barrel at 13,38 turn in  #TURNIN\"The Search Continues\"#  accept  #ACCEPT\"Search More Hovels\"#.", x = 13, y = 38, zone = "Wetlands" },
            [40] = { str = "40. Go north again touch the half-burried barrel at 13,34 turn in  #TURNIN\"Search More Hovels\"#  accept  #ACCEPT\"Return the Statuette\"#", x = 13, y = 34, zone = "Wetlands" },
            [41] = { str = "41. Stop at the sunken ships around 14,28 14,25 and kill the undead on either ship for  #DOQUEST\"The Cursed Crew\"#  Try to stay on top of the ships. Kill #NPCSnellig# in the broken part of the first ship in the rear near the shore for the box.", x = 14, y = 28, zone = "Wetlands" },
            [42] = { str = "42. From here north you should be able to find Giant crocolisks for  #DOQUEST\"Apprentice's Duties\"#  as well as the fen dwellers (track hidden) in the waters all over this area while you head toward Ironbeard’s Tomb at 44,25 for  #DOQUEST\"Digging Through the Ooze\"#  Kill oozes for the bag.", x = 44, y = 25, zone = "Wetlands" },
            ...
            [45] = { str = "45. Just outside turn in  #TURNIN\"The Cursed Crew\"#  accept  #ACCEPT\"Lifting the Curse\"#." },
            [46] = { str = "46. Go north a little bit and turn in  #TURNIN\"Digging Through the Ooze\"#" },
            [47] = { str = "47. Go to the west side of town, turn in  #TURNIN\"Apprentice's Duties\"#." },
            [48] = { str = "48. Next down to the docks, turn in  #TURNIN\"Return the Statuette\"#" },
            [49] = { str = "49. You should be level 27 now. " },
            [50] = { str = "50. Fly to IF, get new skills, turn in  #TURNIN\"An Old Colleague\"#  at 71,51 SKIP the next part", x = 71, y = 51, zone = "Wetlands" },
            [51] = { str = "51. Fly to SW, turn in  #TURNIN\"A Gnome’s Respite\"#  at 43,80 SKIP the next part", x = 43, y = 80, zone = "Wetlands" },
