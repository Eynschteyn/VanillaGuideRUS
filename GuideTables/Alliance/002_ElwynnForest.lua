...
-----------1-10 Elwynn Forest
	...
	[0110] = {
		...
		items = {
			...
			[50] = { str = "50. Илите в лагерь мурлоков в точке 79,55 и ищите там изувеченное тело (возможно понадобится помошь, но там всегда есть проходящие люди) затем сдайте задание #TURNINDiscover Rolf’s Fate# и возьмите #ACCEPTReport to Thomas#", x = 79, y = 55, zone = "Elwynn Forest" },
			...
			[53] = { str = "53. Идите в точку 90,78 убивайте бандитов и собирайте красные банданы для задания #DOQUESTRed Linen Goods# пока не выбьете все", x = 90, y = 78, zone = "Elwynn Forest" },
			...
			[55] = { str = "55. Спуститесь к тыквенному полю в точке 69,78 и убейте остальный defias для задания #DOQUESTRed Linen Goods# ", x = 69, y = 78, zone = "Elwynn Forest" },
			[56] = { str = "56. Возможно вы найдете #NPCFurlbrow's Deed# на defias пока будете их убивать просто пока предержите его." },
			[57] = { str = "57. Идите в точку 79,68 и сдайте задание #TURNINRed Linen Goods# вы должы стать 9 уровня или сильно приблизиться к нему", x = 79, y = 68, zone = "Elwynn Forest" },
