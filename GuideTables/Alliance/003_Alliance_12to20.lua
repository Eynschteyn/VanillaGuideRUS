...
-----------17-18 Loch Modan
	...
	[1718] = {
		...
		items = {
			...
			[2] = { str = "2. Остановитесь прямо у башни в Loch Modan в точке 24,18 и возьмите задание  #ACCEPTFilthy Paws#  и  #ACCEPTStormpike's Order#", x = 24, y = 18, zone = "Loch Modan" },
			[3] = { str = "3. Бегите в пещеру в точке 35,18 и выполните задание  #DOQUESTFilthy Paws#.  Коробки лежат на земле. Затем вернитесь и сдайте задание в точку 24,18", x = 35, y = 18, zone = "Loch Modan" },
			[4] = { str = "4. Когда прибудете в Thelsamar откройте полетчика в точке 33,50.", x = 33, y = 50, zone = "Loch Modan" },
			[5] = { str = "5. Берите задание  #ACCEPTIronband's Excavation#  в последнем доме справа." },
			[6] = { str = "6. Сдайте задание  #TURNINIronband's Excavation#  в точке 64,66 и возьмите следующее  #ACCEPTGathering Idols#.", x = 64, y = 66, zone = "Loch Modan" },
			[7] = { str = "7. Возьмите задание  #ACCEPTExcavation Progress Report#  в точку 65,65", x = 65, y = 65, zone = "Loch Modan" },
			[8] = { str = "8. Выполните задание  #DOQUESTGathering Idols#  сдесь а затем сразу сдайте его." },
			[9] = { str = "9. Идите за место раскопок к дому по координатам 82,62.", x = 82, y = 62, zone = "Loch Modan" },
			[10] = { str = "10. При входе поверните на право и возьмите задание  #ACCEPTCrocolisk Hunting#  (за спиной у тренера охотников) затем пройдите в другую сторону и возьмите задание  #ACCEPTA Hunter's Boast# " },
			[11] = { str = "11. Идите и выполните задание  #DOQUESTA Hunter's Boast#  перед домом." },
			[12] = { str = "12. Сдайте задание  #TURNINA Hunter's Boast#  и возьмите задание  #ACCEPTA Hunter's Challenge#  идите его выполнять по координатам 75,41.", x = 75, y = 41, zone = "Loch Modan" },
			[13] = { str = "13. Сдайте  #TURNINA Hunter's Challenge#  и возьмите следующее  #ACCEPTVyrin's Revenge pt.1#" },
			[14] = { str = "14. Идите по координатам 63,47 и возьмите задание  #ACCEPTBingles' Missing Supplies#. Для этого задания необходимо предварительное задание  #ACCEPTFind Bingles#  которое берется в точке 69,50 в Ironforge", x = 63, y = 47, zone = "Loch Modan" },
			[15] = { str = "15. Выполняйте задание  #DOQUESTCrocolisk Hunting#  на берегу и на острове по координатам 54,38", x = 54, y = 38, zone = "Loch Modan" },
			[16] = { str = "16. Все необходимое для задания  #DOQUESTBingles' Missing Supplies#  можно найти по координатам (54,27 blastencapper), (48,30 wrench), (51,23 hammer), (48,20 screwdriver)", x = 54, y = 27, zone = "Loch Modan" },
			[17] = { str = "17. Идите к плотине с западной стороны и примите задание  #ACCEPTA Dark Threat Looms pt.1#  в точке 45,13 затем выйдите через восточный вход и сдайте задание бочке охраняемую 2мя саперами и возьмите задание  #ACCEPTA Dark Threat Looms pt.2#", x = 45, y = 13, zone = "Loch Modan" },
			[18] = { str = "18. Сдайте задание  #TURNINA Dark Threat Looms pt.2#  в точке 45,13", x = 45, y = 13, zone = "Loch Modan" },
			[19] = { str = "19. Бегите вдоль заподного побережъя и сдайте задание  #TURNINExcavation Progress Report#  в Thelsamar, далее берите следующее  #ACCEPTReport to Ironforge#." },
			[20] = { str = "20. Идите в точку 38,61 и выполните задание  #DOQUESTVyrin's Revenge pt.1#", x = 38, y = 61, zone = "Loch Modan" },
			[21] = { str = "21. Вернитесь в дом по координатам 83,62 и сдайте задание  #TURNINCrocolisk Hunting#  и  #TURNINVyrin's Revenge pt.1#  берите следующее  #ACCEPTWyrin’s Revenge pt.2#.", x = 83, y = 62, zone = "Loch Modan" },
			[22] = { str = "22. Сдайте задание  #TURNINWyrin’s Revenge pt.2#  за собой." },
			[23] = { str = "23. Идите в точку 63,47 и сдайте  #TURNINBingles' Missing Supplies#", x = 63, y = 47, zone = "Loch Modan" },
			...
			[26] = { str = "26. Пройдите нвставнику оружия в IF в точке 61,89. Откройте полетчика в точке 55,38 сдайте задание  #TURNINReport to Ironforge#  в точке 74,12 ПРОПУСТИТЕ следующее задание  #VIDEOPowder to Ironband#", x = 74, y = 12, zone = "Ironforge" },
			[27] = { str = "27. Садись на метро в точке 76,51", x = 76, y = 51, zone = "Ironforge" },
			[28] = { str = "28. Сдайте задание  #TURNINStormpike's Order#  в точке 58,16 в Stormwind", x = 58, y = 16, zone = "Stormwind City" },
...
-----------18-20 Redridge Mountains
	...
	[1820] = {
		...
		items = {
			...
			[2] = { str = "2. Берите задание  #ACCEPTEncroaching Gnolls#  у патруля в точке 15,71", x = 15, y = 71, zone = "Redridge Mountains" },
			[3] = { str = "3. Сдайте задание  #TURNINEncroaching Gnolls#  в точке 30,60 и возьмите следующее  #ACCEPTAssessing the Threat#", x = 30, y = 60, zone = "Redridge Mountains" },
			[4] = { str = "4. Откройте полетчика." },
			[5] = { str = "5. Перейдите мост возьмите задание справа  #ACCEPTBlackrock Menace#, с лева примите  #ACCEPTThe Lost Tools#" },
			[6] = { str = "6. ПРОПУСТИТЕ задания  #VIDEOElmore's Task#  и  #VIDEOThe Price of Shoes#" },
			[7] = { str = "7. Возьмите задание  #ACCEPTHilary's Necklace#  на пристани." },
			[8] = { str = "8. Возьмите задание  #ACCEPTSelling Fish#  возле сарая перед домом." },
			[9] = { str = "9. Зайдите в гостиницу и возьмите задание  #ACCEPTA Free Lunch#,  задание  #VIDEODry Times# ПРОПУСТИТЕ" },
			[10] = { str = "10. Идите на запад от Lakeshire и возьмите задание  #ACCEPTRedridge Goulash#." },
			[11] = { str = "11. Добудьте Great Goretusk Snouts к западу от домов (watch out for bellygrub we’ll get him later) для задания  #DOQUESTRedridge Goulash#." },
			[12] = { str = "12. Затем направляйтесь в точку 41,54 для выполнения задания  #DOQUESTThe Lost Tools#  и задания  #DOQUESTSelling Fish#  убивая мурлоков, ныряйте к куче грязи под водой что бы получить ожерелье для задания  #DOQUESTHilary's Necklace#. Сохрание 8 murloc fins для следующего задания", x = 41, y = 54, zone = "Redridge Mountains" },
			[13] = { str = "13. Сдайте задание  #TURNINThe Lost Tools#  у моста и примите следующее  #ACCEPTThe Everstill Bridge#" },
			[14] = { str = "14. Сдайте задание ожерелье  #TURNINHilary's Necklace#  на пристань." },
			[15] = { str = "15. Сдайте задание  #TURNINSelling Fish#  у сарая перед домами." },
			[16] = { str = "16. К этому моменту вы уже должны быть на пол пути к 20му уровню." },
			[17] = { str = "17. Сдайте задание  #TURNINA Free Lunch#  в точке 14,70 и возьмите задание #ACCCEPTVisit the Herbalist#.", x = 14, y = 70, zone = "Redridge Mountains" },
			[18] = { str = "18. Убивайте пауков для задания  #DOQUESTRedridge Goulash#  по координатам 14,70 и 29,83.", x = 29, y = 83, zone = "Redridge Mountains" },
			[19] = { str = "19. Выполняйте задание  #DOQUESTAssessing the Threat#  по координатам 29,83 и 41,73.", x = 41, y = 73, zone = "Redridge Mountains"},
			[20] = { str = "20. Убивайте крокодилов для задания  #DOQUESTRedridge Goulash#  в точке 57,73.", x = 57, y = 73, zone = "Redridge Mountains" },
			[21] = { str = "21. Сдайте задание  #TURNINAssessing the Threat#  около полетчика." },
			[22] = { str = "22. Возьмите задание  #ACCEPTMurloc Poachers#  перед сараем." },
			[23] = { str = "23. Остановитесь у дома к западу от Lakeshire и сдайте задание  #TURNINVisit the Herbalist#  берите следующее  #ACCEPTDelivering Daffodils#." },
			[24] = { str = "24. Идите к следующему дому и сдайте задание  #TURNINRedridge Goulash#." },
			[25] = { str = "25. Зайдите в гостиницу и сдайте задание  #TURNINDelivering Daffodils#." },
			[26] = { str = "26. Убивайте мурлоков к востоку от моста для задания  #DOQUESTMurloc Poachers#." },
			[27] = { str = "27. Убивайте гнолов к северу от Lakeshire для задания  #DOQUESTThe Everstill Bridge#." },
			[28] = { str = "28. Сдайте задание  #TURNINThe Everstill Bridge#  рядом с мостом." },
