...
-----------31-31 Alterac Mountains
	...
	[3131] = {
		...
		items = {
			...
			[5] = { str = "#HUNTER5. Die on purpose so you end up in Southshore and then get your cat back out#"},
...
-----------32-32 Stranglethorn Vale
	...
	[3232] = {
		...
		items = {
			...
			[7] = { str = "#HUNTER7. Go to 29,8 just West of Nessingway’s and tame a Stranglethorn Tiger for Dash Rank 1. Use this pet until you get to Booty Bay#", x = 29, y = 8, zone = "Stranglethorn Vale"},
...
-----------33-35 Desolace
	...
	[3335] = {
		...
		items = {
			...
			[30] = { str = "30. Используйте #PICTUREHearth# to Nijel’s" },
			...
			[34] = { str = "#HUNTERS34)Обойдите кладбище кадо и приручите скорпиона 34 уровня и выучите навык пета claw rank 5. Скорпионы ходят в точке 37,80#", x = 37, y = 80, zone = "Desolace" },
			[35] = { str = "35. Сейчас до 35 уровня должно остаться 2 деления. Можно гриндить кентавров в точке 37,80 до 35 уровня", x = 37, y = 80, zone = "Desolace" },
			[36] = { str = "36. Двигайтесь в Feralas и откройте полетчика это сократит время в двльнейшем." },
			[37] = { str = "37. Идите на корабль в точке 43,42 плывите на остров и откройте полетчика. Летите до Theramore, а потом до Rachet.", x = 43, y = 42, zone = "Desolace" },
			[38] = { str = "38. Зайдите к гоблину в точке 62,36 и сдайте задание  #TURNINGoblin Sponsorship pt.1#  возьмите следующее  #ACCEPTGoblin Sponsorship pt.2#  Затем сдайте задание на пристане  #TURNINWharfmaster Dizzywig#  и берите следующее  #ACCEPTParts for Kravel#", x = 62, y = 36, zone = "Desolace" },
			[39] = { str = "39. Идите на корабль и отправляйтесь в Booty Bay" },
		}
	},
...
-----------35-36 Stranglethorn Vale
	...
	[3536] = {
		...
		items = {
			...
			[17] = { str = "17. Accept  #ACCEPTSpecial Forces#" },
			[18] = { str = "18. Go to the Inn looking building at 43,9 touch the book on the 2nd floor and hand in  #TURNINBookie Herod#  accept  #ACCEPTThe Hidden Key#", x = 43, y = 9, zone = "Stranglethorn Vale" },
			[19] = { str = "19. Go in the cave at 45,7 and kill the mobs in here for  #DOQUESTSpecial Forces#  and make your way to the chest for  #DOQUESTBookie Herod# , it’s down the first fork, only 1 level down then in the boxes. Accept  #ACCEPTThe Spy Revealed!#  (Easy from here)", x = 45, y = 7, zone = "Stranglethorn Vale" },
			[20] = { str = "20. Now grind back out since you should be close to level 36. Once your out go back to the rebel camp." },
			[21] = { str = "21. Hand in  #TURNINSpecial Forces#  SKIP the next part" },
			[22] = { str = "22. Hand in  #TURNINThe Spy Revealed!#  accept  #ACCEPTPatrol Schedules#  turn around and hand that in and accept  #ACCEPTReport to Doren#  then turn around again and hand that back in (told you it was easy)" },
			[23] = { str = "23. You should definitely be level 36 by now. We’ll get skills soon" },
			[24] = { str = "24. Go south toward the GY, then go west north of the river and kill basalisks for  #DOQUESTSinging Blue Shards#  if you don’t get them all now don’t worry there is more south." },
			[25] = { str = "25. Kill Bloodscalp at 29,19 for  #DOQUESTBloodscalp Ears#  You’ll probably have to clear it 2-3 times. They’re easy", x = 29, y = 19, zone = "Stranglethorn Vale" },
			[26] = { str = "26. Kill Basalisks to finish  #DOQUESTSinging Blue Shards#  just west of here above the shore." },
			[27] = { str = "27. Run south on the Island till it says complete for  #DOQUESTThe Stone of the Tides#  Go back up and kill basalisks if needed." },
			[28] = { str = "28. Hearth to BB" },
			[29] = { str = "29. Turn in  #TURNINSinging Blue Shards#  SKIP the next for now" },
			[30] = { str = "30. Go upstairs turn in  #TURNINInvestigate the Camp#,  #TURNINBloodscalp Ears#" },
			[31] = { str = "31. Go just outside, turn in  #TURNINThe Stone of the Tides#  and  #TURNINGoblin Sponsorship pt.4#  Accept  #ACCEPTWater Elementals#  and  #ACCEPTGoblin Sponsorship pt.5#" },
			[32] = { str = "32. Go into the shop Tan-Your-Hide Leatherworks and turn in  #TURNINSupply and Demand#  (it’s down the ramp from the FP) accept  #ACCEPTSome assembly required#" },
			[33] = { str = "33. I’m half way to level 37 at this point" },
			[34] = { str = "34. Fly to IF get new skills then fly to Menethil Harbor, make it your home, and sail to Theramore" },
			[35] = { str = "35. If you’re first aid is at 225 go do  #ACCEPTTriage#  then fly to Gadgetzan" },
			[36] = { str = "36. Run out to Shimmering Flats at 77,77 and turn in  #TURNINParts for Kravel#  accept  #ACCEPTDelivery to the Gnomes#  then turn around and hand it in", x = 77, y = 77, zone = "Stranglethorn Vale" },
...
-----------37-38 Arathi Highlands
	...
	[3738] = {
	    ...
	    items = {
			...
			[10] = { str = "10. Go to refuge point and hand in  #TURNINWorth Its Weight In Gold#  this opens up  #ACCEPTWand Over Fist#  from another NPC" },
			[11] = { str = "11. Go do  #DOQUESTWand Over Fist#  by killing #NPCColdrage# in the cave at 53,77 (follow the left path) run back to Refuge hand it in, SKIP the rest", x = 53, y = 77, zone = "Arathi Highlands" },
			...
			[13] = { str = "13. I found the courier at this point on the road (varies since he travels)" },
			[14] = { str = "14. Go to the circle of inner binding at 36,57 and turn in  #TURNINStones of Binding#  on the rock, SKIP the rest.", x = 36, y = 57, zone = "Arathi Highlands" },
			[15] = { str = "15. Run SW of here, there is a path that leads behind Stromgarde at 31,64 follow it around to the cave path at 21,75", x = 31, y = 64, zone = "Arathi Highlands" },
			[16] = { str = "16. Swim over to the ship and accept  #ACCEPTLand HO!#  then turn around and hand it in." },
			[17] = { str = "17. Accept  #ACCEPTDeep Sea Salvage#" },
			[18] = { str = "18. Go by the fire accept  #ACCEPTDrowned Sorrows#  and  #ACCEPTSunken Treasure pt.1#" },
			[19] = { str = "19. Do  #DOQUESTSunken Treasure pt.1#  by escorting him right behind you in the cave. Turn it in, accept  #ACCEPTSunken Treasure pt.2#" },
			[20] = { str = "20. Go down south near the sunken ships, around 24,84 and do  #DOQUESTSunken Treasure pt.2#  (use goggles to find them easy),  #DOQUESTDrowned Sorrows#  (nagas), and  #DOQUESTDeep Sea Salvage#  (2 on each ship)", x = 24, y = 84, zone = "Arathi Highlands" },
			[21] = { str = "21. Turn in  #TURNINDeep Sea Salvage#  on the dock" },
			[22] = { str = "22. Turn in  #TURNINDrowned Sorrows#  next to the fire, then   #TURNINSunken Treasure pt.2#  accept  #ACCEPTSunken Treasure pt.3#" },
			[23] = { str = "23. Hand that in on the dock accept  #ACCEPTSunken Treasure pt.4#" },
			[24] = { str = "24. Run back towards Go’Shek Farm, if you haven’t found the courier yet abandon quest and hearth to SS. If so go to 60,53 and hand in  #TURNINHints of a New Plague? Pt.2#  accept  #ACCEPTHints of a New Plague? Pt.3#  then turn it right back in accept  #ACCEPTHints of a New Plague? Pt.4#", x = 60, y = 53, zone = "Arathi Highlands" },
			[25] = { str = "25. Escort her when done turn it back in  and accept #ACCEPT“Hints of a New Plague? Pt.5”# Grind until youre 3500 xp to level 38" },
			[26] = { str = "26. Hearth to Southshore" },
			[27] = { str = "27. Turn in #TURNIN“Hints of a New Plague? Pt.5”# just outside the Inn" },
			[28] = { str = "28. Fly to Stormwind for new skills and get the quest #ACCEPTMorgan Stern# from Angus Stern at 41 89, then fly to Menethil and sail to Theramore", x = 41, y = 89, zone = "Stormwind" },
		}
	},
...
-----------38-38 Dustwallow Marsh
	...
	[3838] = {
		...
		items = {
			...
			[2] = { str = "2. Run up near the Inn, accept #ACCEPT“They Call Him Smiling Jim”#" },
			[3] = { str = "3. Go in the Inn, accept #ACCEPT“Mudrock Soup and Bugs”# and make Theramore your home. " },
			[4] = { str = "4. Go to the 2nd floor of the castle behind the Inn, not the tower, turn in #TURNIN“They Call Him Smiling Jim”# This gives you hints about some quests at the old Inn near the Barrens." },
			[5] = { str = "5. Buy 3 soothing spices from the trade supplies person in the houst at 66,51 (for upcoming quest) ", x = 66, y = 51, zone = "Dustwallow Marsh" },
			[6] = { str = "6. Just as you exit Theramore, go right and kill Mudrock turtles along the shore for #DOQUEST“Mudrock Soup and Bugs”#" },
			[7] = { str = "7. Go to the house at 55,26 and accept #ACCEPT“Soothing Spices”# then turn it right back in, accept #ACCEPT“Jarl Needs eyes”#", x = 55, y = 26, zone = "Dustwallow Marsh" },
			[8] = { str = "8. Touch the mound of dirt beside the house, accept #ACCEPT“The Orc Report”#" },
			[9] = { str = "9. Run over to Darkmist Cavern at 32,23 and kill spiders inside and outside for #DOQUEST“Jarl Needs eyes”# They drop 1-2 every kill", x = 32, y = 23, zone = "Dustwallow Marsh" },
			[10] = { str = "10. Stop at 35,38 and grab #ACCEPT“Hungry!”#", x = 35, y = 38, zone = "Dustwallow Marsh" },
			[11] = { str = "11. Go to 29,47, the shady rest inn, and grab these 3 quests, touch the hoofprints just out front #ACCEPT“Suspicious Hoofprints”# the badge on the board laying on the floorboards (it’s a tiny badge) #ACCEPT“Lieutenant Paval Reethe pt.1”# and the shield over the fireplace #ACCEPT“The Black Shield pt.1”# ", x = 29, y = 47, zone = "Dustwallow Marsh" },
			[12] = { str = "12. Run over to 54,56 and open the shipping crate for #DOQUEST“Razzeric's Tweaking”#", x = 54, y = 56, zone = "Dustwallow Marsh" },
			[13] = { str = "13. Hearth to Theramore" },
			[14] = { str = "14. Turn in #TURNIN“Mudrock Soup and Bugs”# in front of you, accept #ACCEPT“… and bugs”#" },
			[15] = { str = "15. Go to the docks at the tower and turn in #TURNIN“The Orc Report”# accept #ACCEPT“Captain Vimes”# Run in the castle behind the Inn and turn it in" },
			[16] = { str = "16. Turn in #TURNIN“Lieutenant Paval Reethe pt.1”# accept #ACCEPT“Lieutenant Paval Reethe pt.2”#" },
			[17] = { str = "17. Turn in #TURNIN“The Black Shield pt.1”# accept #ACCEPT“The Black Shield pt.2”#" },
			[18] = { str = "18. Turn in #TURNIN“Suspicious Hoofprints”# accept the next quest " },
			[19] = { str = "19. Turn around and hand in #TURNIN“Lieutenant Paval Reethe pt.2”# accept #ACCEPT“Daelin's Men”# then turn around hand it in accept #ACCEPT“The Deserters pt.1”#" },
			[20] = { str = "20. Go to the blacksmith house, turn in #TURNIN“The Black Shield pt.2”# accept #ACCEPT“The Black Shield pt.3”# go turn it in back up in the castle" },
			[21] = { str = "21. Run out to 55,26 and turn in #TURNIN“Jarl Needs eyes”# SKIP the next", x = 55, y = 26, zone = "Dustwallow Marsh" },
			[22] = { str = "22. Go just NE of here and kill murlocs for #DOQUEST“Hungry!”#" },
			[23] = { str = "23. Stop at 46,17 and clear some raptors until you’re 50% or more into 39, then accept #ACCEPT“Stinky's Escape”# just follow him, and kill what attacks him. Really easy.", x = 46, y = 17, zone = "Dustwallow Marsh" },
			[24] = { str = "24. Stop at 35,38 turn in #TURNIN“Hungry!”#", x = 35, y = 38, zone = "Dustwallow Marsh" },
			[25] = { str = "25. Go to the tower at 35,53 and attack Balos Jacken, at ¼ life he’ll become friendly and then turn in #TURNIN“The Deserters pt.1”# accept #ACCEPT“The Deserters pt.2”#", x = 35, y = 53, zone = "Dustwallow Marsh" },
			[26] = { str = "26. Die so you end up near Theramore" },
			[27] = { str = "27. Turn in #TURNIN“Stinky's Escape”# in the Inn " },
			[28] = { str = "28. Go up in the castle, turn in #TURNIN“The Deserters pt.2”#" },
			[29] = { str = "29. Fly to Gadgetzan and run up to the Shimmering Flats to 80,76 turn in #TURNIN“Razzeric's Tweaking”# accept #ACCEPT“Safety First pt.1”# turn it in in Gadget and accept #ACCEPT“Safety First pt.2”# then run back to the flats and hand it in", x = 80, y = 76, zone = "Dustwallow Marsh" },
