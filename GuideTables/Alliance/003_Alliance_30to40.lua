...
-----------35-36 Stranglethorn Vale
	...
	[3536] = {
		...
		items = {
			...
			[14] = { str = "14. Идите на юг и убейте Sin’Dall на холме в точке 32,17 для задания  #DOQUESTTiger Mastery pt.4#  вернитесь в лагерь и сдайте его", x = 32, y = 17, zone = "Stranglethorn Vale" },
			[15] = { str = "15. Идите в лагерь на север в точку 37,3 и сдайте  #TURNINSupplies to Private Thorsen#, если вы спасете НПС во время потрулирования сможете получить задание  #ACCEPTJungle Secrets#  сдайте его в лагере и берите задание  #ACCEPTBookie Herod#", x = 37, y = 3, zone = "Stranglethorn Vale" },
			[16] = { str = "16. Сдайте задание  #TURNINReturn to Corporal Kaleb#  и заберите свой шлем" },
			[17] = { str = "17. Берите задание  #ACCEPTSpecial Forces#" },
			[18] = { str = "18. Идите в дом в точке 43,9 там на 2м этаже в комнате книга сдайте задание  #TURNINBookie Herod#  и берите следующее  #ACCEPTThe Hidden Key#", x = 43, y = 9, zone = "Stranglethorn Vale" },
			[19] = { str = "19. Зайдите в пещеру 45,7 и убивайте мобов для задания  #DOQUESTSpecial Forces#  идите в глубь пещеры к сдайте задание сундуку  #DOQUESTBookie Herod#, берите следующее задание  #ACCEPTThe Spy Revealed!#  (Easy from here)", x = 45, y = 7, zone = "Stranglethorn Vale" },
			[20] = { str = "20. Так как вы близки к 36 уровню займитесь гриндом. Когда получили 36 уровень вернитесь обратно в лагерь на севере. Изучите навыки чуть позже продолжайте следовать гайду" },
			[21] = { str = "21. Сдайте задание  #TURNINSpecial Forces#  следующие задания ПРОПУСКАЕМ" },
			[22] = { str = "22. Сдайте задание  #TURNINThe Spy Revealed!#  примите задание  #ACCEPTPatrol Schedules#  сдайте задание рядом и возьмите следующее задание  #ACCEPTReport to Doren#  и сдайте его рядом." },
			[23] = { str = "23. Ты точно уже должен быть 36 уровня." },
			[24] = { str = "24. Идите к кладбищу и убивайте василисков вдоль реки для задания  #DOQUESTSinging Blue Shards#  если вы их не собрали все, соберете позже немного южнее." },
			[25] = { str = "25. Убейте Bloodscalp в точке 29,19 для задания  #DOQUESTBloodscalp Ears#", x = 29, y = 19, zone = "Stranglethorn Vale" },
			[26] = { str = "26. Убивайте василисков чтобы закончить с заданием  #DOQUESTSinging Blue Shards#  около берега." },
			[27] = { str = "27. Идите на южный остров для выполнения задания по разветке территории  #DOQUESTThe Stone of the Tides#.  Вернитесь обратно и убивайте василисков если это необходимо." },
			[28] = { str = "28. Жмите Hearthstone в Бути Бей (Пиратская бухта)" },
			[29] = { str = "29. Сдайте задание  #TURNINSinging Blue Shards#  пока что ПРОПУСТИТЕ следующее задание." },
			[30] = { str = "30. Поднимитесь наверх и сдайте 2 задания  #TURNINInvestigate the Camp#,  #TURNINBloodscalp Ears#" },
			[31] = { str = "31. Выйдите наружу и сдайте задание  #TURNINThe Stone of the Tides#  и  #TURNINGoblin Sponsorship pt.4#  примите следующие задания  #ACCEPTWater Elementals#  и  #ACCEPTGoblin Sponsorship pt.5#" },
			[32] = { str = "32. Сдайте задание  #TURNINSupply and Demand#  (находится под полетчиком) и примите задание  #ACCEPTSome assembly required#" },
