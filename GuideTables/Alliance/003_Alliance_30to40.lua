...
-----------38-40 Stranglethorn Vale
	...
	[3840] = {
		...
		items = {
			...
			[14] = { str = "14. Вам нужно убить Bhag'thera (элитный моб) для задания  #DOQUEST“Panther Mastery pt.4”#  в точке 49,25. Рядом с бывают 2 обычных моба в инвизе. Самый простой способ сделать это задание это убить ее в 2-ем, но и в соло это сделать тоже возможно.", x = 48, y = 25, zone = "Stranglethorn Vale" },
			...
			[40] = { str = "40. Идите на юг в Badlands в точку 46,76", x = 46, y = 76, zone = "Loch Modan" },
		}
	},
}
