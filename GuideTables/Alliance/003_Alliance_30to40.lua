...
-----------38-40 Stranglethorn Vale
	...
	[3840] = {
		...
		items = {
			...
			[35] = { str = "35. Теперь вы точно 40 уровня летите в свои рассовые города и купите маунта, конечно если у вас есть деньги ))), изучите новые навыки у классового тренера." },
			...
			[41] = { str = "41. Бегите в точку 65,65 и возьмите задание  #ACCEPT“Find Agmond”#", x = 65, y = 65, zone = "Loch Modan" },
