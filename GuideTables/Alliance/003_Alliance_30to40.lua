...
-----------33-35 Desolace
	...
	[3335] = {
		...
		items = {
			...
			[34] = { str = "34. #HUNTER34)Обойдите кладбище кадо и приручите скорпиона 34 уровня и выучите навык пета claw rank 5. Скорпионы ходят в точке 37,80#", x = 37, y = 80, zone = "Desolace" },
