...
-----------33-35 Desolace
	...
	[3335] = {
		...
		items = {
			...
			[2] = { str = "01) Сделайте Nijel’s Point в Desolace своим домом, а затем летите в Stonetalon и сдайте задание  #TURNINReclaiming the Charred Vale#  следующее задание ПРОПУСКАЕМ." },
			[3] = { str = "02) Прожимаем #PICTUREHearth# и позврошаемся в Desolace" },
			[4] = { str = "03) Идите на юг от инкипера и сдайте задание  #TURNINReclaimers' Business#  в Desolace  и примите 2 задания  #ACCEPTReagents for Reclaimers Inc pt.1#  и  #ACCEPTThe Karnitol Shipwreck pt.1#" },
			[5] = { str = "04) Я ПРОПУСКАЮ оба квеста с кентаврами разных фракций. Это просто бесполезная рутина ради двух квестов, которые того не стоят." },
			[6] = { str = "05) Берем задание  #ACCEPTCentaur Bounty#" },
			[7] = { str = "06) Идем к выходу из лагеря и берем  #ACCEPTVahlarriel's Search pt.1#" },
			[8] = { str = "07) Идем на запад по координатам 56,17 сдаем  #DOQUESTVahlarriel's Search pt.1#  и берем  #ACCEPTVahlarriel’s Search pt.2#", x = 56, y = 17, zone = "Desolace" },
			[9] = { str = "08) Идите на восток в Sargeron по координатам 75,20 и убивайте сатиров для задания  #DOQUESTReagents for Reclaimers Inc pt.1#", x = 75, y = 20, zone = "Desolace" },
			[10] = { str = "09) Идите обратно в Nijel’s, и сдайте  #TURNINVahlarriel’s Search pt.2#  и берем  #ACCEPTVahlarriel’s Search pt.3#" },
			[11] = { str = "10) Боднимитесь еще немного и сдайте  #TURNINReagents for Reclaimers Inc pt.1#  и берем  #ACCEPTReagents for Reclaimers Inc pt.2#" },
			[12] = { str = "11) Начинайте бить скрпионов по пути к  #DOQUESTReagents for Reclaimers Inc pt.2#  направляясь к точке 62,38 и берем задание  #ACCEPTBone Collector#  убиваем скорпов пока бежим (шанс дропа низкий)", x = 62, y = 38, zone = "Desolace" },
			[13] = { str = "12) Двигаемся на восток в деревню кентавров примерно в точке 72,45. Убиваем их и собираем уши для задания  #DOQUESTCentaur Bounty#  продолжайте фармить их до 34 уровня", x = 72, y = 45, zone = "Desolace" },
			[14] = { str = "13) Двигайтесь в точку 60,61 и берем задание  #ACCEPTKodo Roundup#  начинайте водить желтых кадо с кладбища пока не приведете 5 штук.", x = 60, y = 61, zone = "Desolace" },
			[15] = { str = "14) Вокруг кладбона ходят старые кадо убивайте их и лутайте 3 шкуры для задания  #DOQUESTReagents for Reclaimers Inc pt.2#." },
			[16] = { str = "15) Отправляйтесь на кладбище кадо в точку 51,58. и выполните задание  #DOQUESTBone Collector#.", x = 51, y = 58, zone = "Desolace" },
			[17] = { str = "16) Как только закончите все задания на кладбище кадо бегите на северо-запад в сторону воды. Убивайте скорпионов если они нужны." },
			[18] = { str = "17) Возьмите задание  #ACCEPTSceptre of Light#  по координатам 38,27 рядом с большой башней", x = 38, y = 27, zone = "Desolace" },
			[19] = { str = "18) Идите на юг по пляжу до координат 36,30 завершите задание (сундук)  #DOQUESTThe Karnitol Shipwreck pt.1#  и возьмите следующее  #ACCEPTThe Karnitol Shipwreck pt.2#  возьмите задание рядом  #ACCEPTClaim Rackmore's Treasure!#  (книга). Если квест лог заполнен отмените задание CENTAUR BOUNTY.", x = 36, y = 30, zone = "Desolace" },
			[20] = { str = "19) Убивайте Drysnaps под водой у разбитого коробля для получение the silver key  для задания  #DOQUESTClaim Rackmore's Treasure!#  и бейте Наг для the golden key. Муторный квест терпите." },
			[21] = { str = "20) Идите в здание в точке  56,29 в центре него сдайте задание  #TURNINVahlarriel’s Search pt.3#  в точке 54,26 берите следующее задание  #ACCEPTSearch for Tyranis#", x = 54, y = 26, zone = "Desolace" },
			[22] = { str = "21) Выходите наружу на дозорной башне справа убейте НПС для задания  #DOQUESTSceptre of Light#" },
			[23] = { str = "22) Отправляйтесь в соседнее здание по координатам 53,29 и убейте Tyranis Malem для задания  #DOQUESTSearch for Tyranis#  затем идите обратно в здание к эльфийке. Расчистите путь для выполнения задания на сопровождение.", x = 53, y = 29, zone = "Desolace" },
			[24] = { str = "23) Берем задание  #ACCEPTReturn to Vahlarriel#  НЕ БЕЙТЕ мобов вперед эльфийки пусть она агрит первая в противном случае она продолжит идти и не будет вас защищать." },
			[25] = { str = "24) Идите в точку 62,38 и сдайте задание  #TURNINBone Collector#", x = 62, y = 38, zone = "Desolace" },
			[26] = { str = "25) Вернитесь в точку 38,27 и сдайте задание  #TURNINSceptre of Light#  и примите  #ACCEPTBook of the Ancients#", x = 38, y = 27, zone = "Desolace" },
			[27] = { str = "26) Плывите на северо-запад по карте до острова Ranazjar Isle и откройте сундук в точке 30,9 и сдайте задание  #DOQUESTClaim Rackmore's Treasure!#", x = 30, y = 9, zone = "Desolace" },
			[28] = { str = "27) Идите в заднюю часть острова к статуе в точке 28,7. Зачистите территорию около нее и выполните задание  #DOQUESTBook of the Ancients#  бывает баг нужно юзать предмет в инвентаре а затем кликать на статую.", x = 28, y = 7, zone = "Desolace" },
			[29] = { str = "28) Плывите обратно в точку 38,27 и сдайте задание  #TURNINBook of the Ancients#", x = 38, y = 27, zone = "Desolace" },
			[30] = { str = "29) Используйте #PICTUREHearth# to Nijel’s" },
			[31] = { str = "30) Идите на юг и сдайте квест  #TURNINReagents for Reclaimers Inc pt.2#  Пока что ПРОПУСТИТЕ 3ю часть цепочки, и  #ACCEPTThe Karnitol Shipwreck pt.2#  тоже ПРОПУСТИТЕ." },
			[32] = { str = "31) Пройдите южнее и сдайте задание  #TURNINCentaur Bounty#" },
			[33] = { str = "32) Сдайте задание  #TURNINReturn to Vahlarriel#" },
			[34] = { str = "#HUNTERS33)Обойдите кладбище кадо и приручите скорпиона 34 уровня и выучите навык пета claw rank 5. Скорпионы ходят в точке 37,80#", x = 37, y = 80, zone = "Desolace" },
			[35] = { str = "34) Сейчас до 35 уровня должно остаться 2 деления. Можно гриндить кентавров в точке 37,80 до 35 уровня", x = 37, y = 80, zone = "Desolace" },
			[36] = { str = "35) Двигайтесь в Feralas и откройте полетчика это сократит время в двльнейшем." },
			[37] = { str = "36) Идите на корабль в точке 43,42 плывите на остров и откройте полетчика. Летите до Theramore, а потом до Rachet.", x = 43, y = 42, zone = "Desolace" },
			[38] = { str = "37) Зайдите к гоблину в точке 62,36 и сдайте задание  #TURNINGoblin Sponsorship pt.1#  возьмите следующее  #ACCEPTGoblin Sponsorship pt.2#  Затем сдайте задание на пристане  #TURNINWharfmaster Dizzywig#  и берите следующее  #ACCEPTParts for Kravel#", x = 62, y = 36, zone = "Desolace" },
			[39] = { str = "38) Идите на корабль и отправляйтесь в Booty Bay" },
		}
	},
