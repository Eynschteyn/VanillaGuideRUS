...
-----------32-33 Thousand Needles (Shimmering Flats)
	...
	[3233] = {
		...
		items = {
			...
			[11] = { str = "11. УбивайKill Basilisks around 73,59 for  #DOQUESTA Bump in the Road#", x = 73, y = 59, zone = "Thousand Needles" },
...
-----------38-38 Dustwallow Marsh
	...
	[3838] = {
		...
		items = {
			...
			[12] = { str = "12. Идите в точку 29,47, зайдите в сгоревшую гостинницу и возьмите 3 задания коснитесь следов копыт у входа и возьмите задание  #ACCEPT“Suspicious Hoofprints”#, значка лежащего на ковре (он маленький) и возьмите задание  #ACCEPT“Lieutenant Paval Reethe pt.1”# и щита над комином задание  #ACCEPT“The Black Shield pt.1”# ", x = 29, y = 47, zone = "Dustwallow Marsh" },
			[13] = { str = "13. Идите в точку 54,56 и откройте ящик для задания  #DOQUEST“Razzeric's Tweaking”#", x = 54, y = 56, zone = "Dustwallow Marsh" },
			[14] = { str = "14. Жмите Hearth в Theramore" },
			[15] = { str = "15. Сдайте  #TURNIN“Mudrock Soup and Bugs”# перед собой, возьмите задание  #ACCEPT“… and bugs”#" },
			[16] = { str = "16. Идите к причалу у башни и сдайте задание  #TURNIN“The Orc Report”# примите следующее #ACCEPT“Captain Vimes”# Идите в замок за таверной и сдайте задание." },
			...
			[20] = { str = "20. Повернитесь и сдайте  #TURNIN“Lieutenant Paval Reethe pt.2”#  возьмите  #ACCEPT“Daelin's Men”#  повернитесь и сдайте задание затем берите новое  #ACCEPT“The Deserters pt.1”#" },
			...
			[32] = { str = "32. Жмитие Hearth в Theramore и летие в Rachet, сядьте на корабль до Booty Bay" },
		}
	},
...
-----------38-40 Stranglethorn Vale
	...
	[3840] = {
		...
		items = {
			...
			[4] = { str = "4. Сделайте Booty Bay своим домом, возьмите задание  #ACCEPT“Venture Company Mining”#" },
			[5] = { str = "5. Поднимитесь на верх и сдайте  #TURNIN“The Rumormonger”#  возьмите  #ACCEPT“Dream Dust In the Swamp”#  и  #ACCEPT“Skullsplitter Tusks”#" },
			[6] = { str = "6. Выйдите наружу и сдайте задание  #TURNIN“Sunken Treasure pt.4”# следующее задание ПРОПУСТИТЕ" },
			[7] = { str = "7. Отправляйтесь по координатам 33,39 и убивайте рапторов для задания  #DOQUEST“Raptor Mastery pt.3”#", x = 33, y = 39, zone = "Stranglethorn Vale" },
			[8] = { str = "8. Убивайте Snapjaw Crocolisks вдоль ручья в точке 38,30 до озера в точке 41,19 для задания  #DOQUEST“Some assembly required”#", x = 38, y = 30, zone = "Stranglethorn Vale" },
			[9] = { str = "9. Отправляйтесь на остров по координатам 20,23 и убивайте элементалей для задания  #DOQUEST“Water Elementals”#." },
			[10] = { str = "10. Сейчас вы должны быть уже близки к 39 уровню можете остаться сдесь и гриндить элементалей, либо пойти по координатам 33,39 и гриндить рапторов и василисков до 39 уровня.", x = 20, y = 23, zone = "Stranglethorn Vale" },
			[11] = { str = "11. Как только достигните 39 уровня продвигайтесь на восток к дороге затем к точке 41,41 и убивайте гоблинов для задания  #DOQUEST“Venture Company Mining”#", x = 41, y = 41, zone = "Stranglethorn Vale" },
			[12] = { str = "12. Бегите в лагерь по координатам 42,37 и выполните задание  #DOQUEST“Skullsplitter Tusks”#", x = 42, y = 37, zone = "Stranglethorn Vale" },
			[13] = { str = "13. Вам нужно убить Bhag'thera (элитный моб) для задания  #DOQUEST“Panther Mastery pt.4”#  в точке 49,25. Рядом с бывают 2 обычных моба в инвизе. Самый простой способ сделать это задание это убить ее в 2-ем, но и в соло это сделать тоже возможно.", x = 48, y = 25, zone = "Stranglethorn Vale" },
			[14] = { str = "14. Прожимаем Hearth назад в Booty Bay" },
			[15] = { str = "15. Сдаем задание  #TURNIN“Venture Company Mining”#" },
			[16] = { str = "16. Поднимитесь на верх и сдайте задание  #TURNIN“Skullsplitter Tusks”#" },
			[17] = { str = "17. Выйдите на улицу и сдайте задание  #TURNIN“Water Elementals”# следующее задание ПРОПУСТИТЕ." },
			[18] = { str = "18. Зайдите в магазин Tan-Your-Hide Leatherworks и сдайте задание  #TURNIN“Some assembly required”# и возьмите следующее  #ACCEPT“Excelsior”#" },
			[19] = { str = "19. Выходите из Booty Bay и идите на лево к пиратскому лагерю в точку 27,69 коснитесь письма на бочке и сдайте задание  #TURNIN“The Bloodsail Buccaneers pt.1”#  берите следующее  #ACCEPT“The Bloodsail Buccaneers pt.2”#", x = 27, y = 69, zone = "Stranglethorn Vale" },
			[20] = { str = "20. Отправляйтесь убивать горилл в точку 32,65 на северо-востоке от Booty Bay для задания  #DOQUEST“Scaring Shaky”#", x = 32, y = 65, zone = "Stranglethorn Vale" },
			[21] = { str = "21. Идите обратно в Booty Bay" },
			[22] = { str = "22. Поверните на лево после тунеля и сдайте задание  #TURNIN“Scaring Shaky”#  возьмите следующее задание  #ACCEPT“Return to MacKinley”#" },
			[23] = { str = "23. Следуйте вдоль нижнего причала к инкиперу и сдайте задание  #TURNIN“The Bloodsail Buccaneers pt.2”#  берите следующее  #ACCEPT“The Bloodsail Buccaneers pt.3”#" },
			[24] = { str = "24. Зайдите в дом на против полукоробля и сдайте задание  #TURNIN“Return to MacKinley”#  следующее возьмите  #ACCEPT“Voodoo Dues”#" },
			...
			[34] = { str = "34. Летите в IF и возьмите задание  #ACCEPT“Ironband Wants You”#  у Prospector Stormpike в точке 74,11. Далее летите к тренеру выучите навыки и купите маунта." },
			[35] = { str = "35.	!Сейчас будет дорогая подготовка к цепочке заданий купите на аукционе frost oil 1 шт и gyrochronatom 1 шт для задания в Badlands если купили эти 2 вещи то купите еще и healing potion 1 шт. и lesser invisibility potion 1 шт. (если вы не купили первые 2 вещи то и остальное покупать не нужно).", x = 74, y = 11, zone = "Iron Forge" },
			[36] = { str = "36. Летите в Loch Modan (если оходник то поставьте питомца в стойло), сделайте Thelsamar своим домом." },
			[37] = { str = "37. Зайдите в гостиницу и возьмите задание  #ACCEPT“Badlands Reagent Run”#" },
			[38] = { str = "38. Бегите в точку 65,65 и возьмите задание  #ACCEPT“Find Agmond”#", x = 65, y = 65, zone = "Loch Modan" },
			[39] = { str = "39. Идите на юг в Badlands в точку 46,76", x = 46, y = 76, zone = "Loch Modan" },
		}
	},
}
