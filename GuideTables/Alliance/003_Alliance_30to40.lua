...
-----------33-35 Desolace
	...
	[3335] = {
		...
		items = {
			...
			[16] = { str = "15) Отправляйтесь на кладбище кадо в точке 51,58. Используйте из инвенторя  #DOQUESTBone Collector#  что бы кадо пошел за вами как только приведете всех сразу сдавайте задание.", x = 51, y = 58, zone = "Desolace" },
