...
-----------35-36 Stranglethorn Vale
	...
	[3536] = {
		...
		items = {
			...
			[11] = { str = "11. Убивайте рапторов в точке 37,22 для задания  #DOQUESTRaptor Mastery pt.2#", x = 37, y = 22, zone = "Stranglethorn Vale" },
			[12] = { str = "12. Убивайте старых тигров в точке 33,18 для задания  #DOQUESTTiger Mastery pt.3#", x = 33, y = 18, zone = "Stranglethorn Vale" },
			[13] = { str = "13. Бегите и убивайте крокодилов в точке 36,10 для задания  #DOQUESTSupply and Demand#" },
			...
			[15] = { str = "15. Идите на юг и убейте Sin’Dall на холме в точке 32,17 для задания  #DOQUESTTiger Mastery pt.4#  вернитесь в лагерь и сдайте его", x = 32, y = 17, zone = "Stranglethorn Vale" },
			[16] = { str = "16. Идите в лагерь на север в точку 37,3 и сдайте  #TURNINSupplies to Private Thorsen#, если вы спасете НПС во время потрулирования сможете получить задание  #ACCEPTJungle Secrets#  сдайте его в лагере и берите задание  #ACCEPTBookie Herod#", x = 37, y = 3, zone = "Stranglethorn Vale" },
			...
			[20] = { str = "20. Зайдите в пещеру 45,7 и убивайте мобов для задания  #DOQUESTSpecial Forces#  идите в глубь пещеры к сдайте задание сундуку  #DOQUESTBookie Herod#, берите следующее задание  #ACCEPTThe Spy Revealed!#  (Easy from here)", x = 45, y = 7, zone = "Stranglethorn Vale" },
			...
			[37] = { str = "37. Бегите на север в соседнюю локаци Shimmering Flats в точку 77,77 и сдайте задание  #TURNINParts for Kravel#  берите следующее  #ACCEPTDelivery to the Gnomes#  затем сдайте его его.", x = 77, y = 77, zone = "Stranglethorn Vale" },
