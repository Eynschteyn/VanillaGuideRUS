...
-----------6-12 Dun Morogh
    ...
    [0612] = {
        ...
        items = {
            ...
            [70] = { str = "70. Спуститесь в яму и бейте троггов тут и в пещере для заданий #DOQUEST\"The Public Servant\"# и #DOQUEST\"Those Blasted troggs!\"#. Сдайте задания в точке 68,55" },
            [71] = { str = "71. Идите на восток в точку 80,51 и идите по тропе в Loch Modan", x = 80, y = 51, zone = "Dun Morogh" },
            [72] = { str = "72. Идите в точку 22,73 и возьмите задание #ACCEPT\"In Defense of the King's Lands\"#", x = 22, y = 73, zone = "Loch Modan" },
            [73] = { str = "73. Поднимитесь на башню и возьмите задание #ACCEPT\"The Trogg Threat\"#" },
            [74] = { str = "74. В точке 33,50 #PICTUREоткройте полетчика#", x = 33, y = 50, zone = "Loch Modan" },
            [75] = { str = "75. Нйдите Mountaineer Kadrell и возьмите задание #ACCEPT\"Rat Catching\"#" },
            [76] = { str = "76. Убейте троггов в точке 27,53 и к северу от него для заданий #DOQUEST\"In Defense of the King's Lands\"# и #DOQUEST\"The Trogg Threat\"#", x = 27, y = 53, zone = "Loch Modan" },
            [77] = { str = "77. Вернитесь в точку 22,73 и сдайте 2 задания из предыдущего пункта", x = 22, y = 73, zone = "Loch Modan" },
            [78] = { str = "78. Идите на север к башне в точке 24,18 и сдайте задание #TURNIN\"Stormpike's Delivery\"#", x = 24, y = 18, zone = "Loch Modan" },
            [79] = { str = "79. К этому моменту вы должны уже достичь 12 уровень или быть близко к его получению если не получили гриндите мобов идите на север через wetlands в menethil, садитесь на корабль (правый причал) и плывите в auberdine" },
        }
    },
}
