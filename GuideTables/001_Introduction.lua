...
Table_001_Introduction = {
    [0001] = {
        ...
        items = {
            ...
            [14] = { str = "#HUNTERСпецефические задания и примечания.#" },
            ...
            --[20] = { str = "." },
            --[9] = { str = "Цветовые обозначения в гайде:" },
            --[10] = { str = "#ACCEPTВзять задание. ГОЛУБОЙ #" },
            --[11] = { str = "#DOQUESTВыполняйте задание. СИНИЙ #" },
            --[12] = { str = "#TURNINСдайте задание. ЗЕЛЕНЫЙ #" },
            --[13] = { str = "#NPCПропустите задание. РОЗОВЫЙ #" },
            --[14] = { str = "#HUNTERСпецефические задания и примечания. КРАСНЫЙ #" },
            --[15] = { str = "#PICTUREНужно исследовать. ОРАНЬЖЕВЫЙ #" },
            --[16] = { str = "#COORDSКвестовые объекты/мобы/итемы. ЖЕЛТЫЙ #" },
        }
    },
